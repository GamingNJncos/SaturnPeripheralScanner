...
Warning - This is my initial pass at this and could be completely broken/non functional atm. It appears to work but if you spot something odd let me know.

**Goal:**
To aid in testing edge cases for [BLE-3D](https://github.com/GamingNJncos/BLE-3D-Saturn-Public) and even more so morbid curiosity as to what's actually enabled in ISO/BIN's vs what was advertised at launch I sl(a/o)pped this together. 

I have a sneaking suspicion a few games are floating around with extra Peripheral support beyond what was advertised, and beta builds/unreleased, specific region games with things (purposely or not) left enabled.  The Saturn has a bunch of various Peripherals and I wasn't aware of a similar tool to do this so here we are. 
...
The script will output a txt file with the same information as printed to terminal
...
Note: If you have done any saturn region patching (also commonly pointed to 0x50 in discussion) before this is right after it. It's actually at 0x60 in most images/bins (but there are things that can impact that). Here look at it, See. The location changes from 50H but the data we're after is the same, right by the region details 
